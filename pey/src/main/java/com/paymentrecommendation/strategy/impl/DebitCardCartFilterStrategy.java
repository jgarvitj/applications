...
public class DebitCardCartFilterStrategy implements CartFilterStrategy {
    @Override
    public PaymentInstrument filterInstrumentsOnCart(PaymentInstrument paymentInstrument, Double amount, LineOfBusiness lineOfBusiness) {
        if((lineOfBusiness.equals(LineOfBusiness.COMMERCE) || lineOfBusiness.equals(LineOfBusiness.CREDIT_CARD_BILL_PAYMENT)) && amount <= 200000) {
