...
import com.paymentrecommendation.service.impl.CartFilterService;
import com.paymentrecommendation.service.impl.FilteredRankingServiceImpl;
import com.paymentrecommendation.service.impl.PaymentRecommenderImpl;
import com.paymentrecommendation.service.impl.UserFilterService;
...
class InvestmentRecommenderTest {
    ...
    @BeforeEach
    void setup() {
        FilteredRankingService filteredRankingService = new FilteredRankingServiceImpl();
        UserFilter userFilter = new UserFilterService();
        CartFilter cartFilter = new CartFilterService();
        paymentRecommender = new PaymentRecommenderImpl(filteredRankingService, userFilter, cartFilter);
    }
